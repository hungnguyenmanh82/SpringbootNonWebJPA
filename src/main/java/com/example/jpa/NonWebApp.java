...
/**
Khai bao web-app nhu binh thuong va them vao config file nhu sau
...
//uncomment @component de chay o non-web app mode
// comment @component de chay o web-app  mode
@Component
